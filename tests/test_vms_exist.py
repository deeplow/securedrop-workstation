...
class SD_VM_Tests(unittest.TestCase):
    ...
    def test_sd_proxy_config(self):
        ...
        self.assertTrue("sd-workstation" in vm.tags)
        self.assertEqual(
            vm.features["service.securedrop-mime-handling-default"], "1"
        )
    ...
    def test_sd_proxy_dvm(self):
        ...
        self.assertFalse(
            vm.features.get("service.securedrop-mime-handling-default", False)
        )
    ...
    def test_sd_app_config(self):
        ...
        # MIME handling
        self.assertEqual(
            vm.features["service.securedrop-mime-handling-sd-app"], "1"
        )
    ...
    def test_sd_viewer_config(self):
        ...
        # MIME handling
        self.assertEqual(
            vm.features["service.securedrop-mime-handling-sd-viewer"], "1"
        )
    ...
    def sd_export_dvm(self):
        ...
        self.assertFalse(
            vm.features.get("service.securedrop-mime-handling-sd-devices", False)
        )
    ...
    def sd_export(self):
        ...
        # MIME handling
        self.assertEqual(
            vm.features["service.securedrop-mime-handling-sd-devices"], "1"
        )
        self._check_service_running(vm, "mime-handling-sd-devices")
